...
use iced::time;
use iced::widget::{
    button, checkbox, column, container, pick_list, row, slider, text, Image, image
};
use iced::window;
use iced::{
...
fn view_controls<'a>(
    ...
    let content = Image::<image::Handle>::new("C:/Users/Staid/Desktop/Projets/rust/vgc/iced_test/data/flower.png").width(15);
    let btn_play = button(content).on_press(Message::TogglePlayback);
    let playback_controls = column![
        btn_play,
        button("Next")
