...
}, Element, Length, Alignment, theme::Button, Background, Color, Vector, BorderRadius};
use iced::Theme;
...
pub fn left_toolbar<'a>() -> Element<'a, MsgLeftToolbar> {
    let content = Image::<image::Handle>::new("iced_test/data/flower.png").width(20).height(16);
...
impl Default for BtnStyle{
    fn default() -> Self {
        BtnStyle { appe: button::Appearance {
