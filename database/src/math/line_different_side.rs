use common::{pures::Vec2, types::Coord, PRECISION};
...
fn create_shape_from_infinite_lines(
    ...
    let distance_max = ((range1.c.approx_distance(range2.c))
        .max(l1.c.approx_distance(l2.c))
        .max(range1.c.approx_distance(l1.c))
        .max(range2.c.approx_distance(l2.c)))
    .sqrt();

    let l1v_coord = Coord {
        c: l1v * distance_max * 4.0,
    } + l1;
    let l2v_coord = Coord {
        c: l2v * distance_max * 4.0,
    } + l2;
...
mod test {
    ...
    fn test_points_are_different_side() {
        ...
        let l1v = Vec2::new(0.5, 0.25).normal();
        let l2 = Coord::new(0.0, 0.0);
        let l2v = Vec2::new(-0.25, -0.5).normal();
    ...
    fn test_points_are_different_side2() {
        ...
        let l1v = Vec2::new(1.0, 0.0).normal();
        let l2 = Coord::new(-0.2, -0.2);
        let l2v = Vec2::new(100.0 + 0.2, -1000.0 + 0.2).normal();
    ...
    fn create_shape_from_infinite_lines_concav() {
        ...
        let point2 = Coord::new(1.0, -1.0);
        let l1 = Coord::new(-0.2, 0.2);
        let l1v = Vec2::new(-100.0, -1000.0).normal();
        let l2 = Coord::new(0.2, -0.2);
        let l2v = Vec2::new(100.0, 100.0).normal();
    ...
    fn create_shape_from_infinite_lines_bug01() {
        //Coord { c: Vec2 { x: 0.69999987, y: -0.5055999 } }, Coord { c: Vec2 { x: 0.6607999, y: 0.49999994 } }, Coord { c: Vec2 { x: 0.7, y: -0.49999997 } }, Vec2 { x: -1.0, y: -6.386212e-8 }, Coord { c: Vec2 { x: 0.7, y: 0.5 } }, Vec2 { x: 0.0, y: 1.0 }
        let point = Coord::new(0.69999987, -0.5055999);
        let point2 = Coord::new(0.6607999, 0.49999994);
        let l1 = Coord::new(0.7, -0.49999997);
        let l1v = Vec2::new(-1.0, -6.386212e-8).normal();
        let l2 = Coord::new(0.7, 0.5);
        let l2v = Vec2::new(0.0, 1.0).normal();
    ...
    fn create_shape_from_infinite_lines_bug02() {
        //Coord { c: Vec2 { x: -0.67199993, y: 0.0 } }, Coord { c: Vec2 { x: -0.69999987, y: 0.7055998 } }, Coord { c: Vec2 { x: -0.7, y: 0.6999999 } }, Vec2 { x: 1.0, y: 5.9604645e-8 }, Coord { c: Vec2 { x: -0.7, y: 0.0 } }, Vec2 { x: 0.0, y: -1.0 }
        let point = Coord::new(-0.67199993, 0.0);
        let point2 = Coord::new(-0.69999987, 0.7055998);

        let l1 = Coord::new(-0.7, 0.6999999);
        let l1v = Vec2::new(1.0, 5.9604645e-8).normal();
    ...
    fn create_shape_from_infinite_lines_bug03() {
        //Coord { c: Vec2 { x: -0.6607999, y: 0.49999994 } }, Coord { c: Vec2 { x: -0.69999987, y: -0.5056 } }, Coord { c: Vec2 { x: -0.7, y: 0.5 } }, Vec2 { x: 0.0, y: 1.0 }, Coord { c: Vec2 { x: -0.7, y: -0.50000006 } }, Vec2 { x: 1.0, y: 6.386212e-8 }
        let point = Coord::new(-0.6607999, 0.49999994);
        let point2 = Coord::new(-0.69999987, -0.5056);

        let l1 = Coord::new(-0.7, 0.5);
        let l1v = Vec2::new(0.0, 1.0).normal();
        let l2 = Coord::new(-0.7, -0.50000006);
        let l2v = Vec2::new(1.0, 6.386212e-8).normal();
    ...
    fn create_shape_from_infinite_lines_bug04() {
        //Coord { c: Vec2 { x: -0.9439999, y: -0.9999999 } }, Coord { c: Vec2 { x: -0.8402806, y: -0.8402806 } }, Coord { c: Vec2 { x: -0.8437499, y: -0.8437499 } }, Vec2 { x: 0.6754437, y: -0.7374116 }, Coord { c: Vec2 { x: -1.0, y: -1.0 } }, Vec2 { x: 0.0, y: 1.0 }
        let point = Coord::new(-0.9439999, -0.9999999);
        let point2 = Coord::new(-0.8402806, -0.8402806);

        let l1 = Coord::new(-0.8437499, -0.8437499);
        let l1v = Vec2::new(0.6754437, -0.7374116).normal();
    ...
    fn create_shape_from_infinite_lines_bug05() {
        //Coord { c: Vec2 { x: -0.83700687, y: -0.8506483 } }-false, Coord { c: Vec2 { x: -0.9999999, y: -0.9439999 } }-false, Coord { c: Vec2 { x: -1.0, y: -1.0 } }, Vec2 { x: 1.0, y: 0.0 }, Coord { c: Vec2 { x: -0.8437499, y: -0.8437499 } }, Vec2 { x: 0.70710677, y: 0.70710677 }
